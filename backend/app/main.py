...
# Import routers
from app.routers import claims, users, comments, rti, dashboard
...
app.add_middleware(
    CORSMiddleware,
    allow_origins=["https://truth-guard-ai-six.vercel.app","http://localhost:3000","http://localhost:3001","https://truthguard-ai.vercel.app","https://truth-guard-r42kohy2s-manas-kumar-arjyas-projects.vercel.app",],  # Preview deployments],  # Next.js frontend (3000/3001)
